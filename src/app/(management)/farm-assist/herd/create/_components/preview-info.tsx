...
// import { Accordion, AccordionItem, Button, DateRangePicker, Input, RangeValue, Textarea } from "@nextui-org/react";
...
//     formState: { errors },
//   } = useForm();
//   const [assignedPigs, setAssignedPigs] = React.useState<PigAssign[]>([]);
...
//     const storedPigs: PigAssign[] = JSON.parse(localStorage.getItem("assignedPigs") || "[]");
...
//           <div className="mt-2 grid grid-cols-3"></div>
...
//                         <div className="mx-2 my-3 p-2 border-2 rounded-xl shadow-md cursor-pointer" key={index}>
...
//             variant="solid"
//             isLoading={loading}
//             isDisabled={code === "" || breed === "" || description === "" || date.end <= date.start || assignedPigs.length === 0}
//             type="submit"
//             size="lg"
//           >
//             Hoàn tất
