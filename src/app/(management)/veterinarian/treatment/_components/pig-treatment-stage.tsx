...
const INITIAL_VISIBLE_COLUMNS = ["pigCode", "cageCode", "breed", "treatmentStageId", "treatmentStageTitle", "isDone"];
...
const PigTreatmentStage = ({
  ...
  const fetchData = async () => {
    try {
      // setIsLoading(true);
      // const response: ResponseObjectList<any> = await vaccinationStageService.getPigsInStage(treatmentStage.id || "", page, rowsPerPage);
