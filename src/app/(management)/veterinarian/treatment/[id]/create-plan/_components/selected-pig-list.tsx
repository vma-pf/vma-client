...
import { columns, INITIAL_VISIBLE_COLUMNS, statusOptions } from "@oursrc/app/(management)/veterinarian/vaccination/create-plan/_models/pig-model-data";
import { CircleAlert, CircleCheck, CircleDashed, Search } from "lucide-react";

const SelectedPigsList = ({
  pigList,
  selectedPigs,
  setSelectedPigs,
}: {
  pigList: Pig[];
  selectedPigs: Pig[];
  setSelectedPigs: React.Dispatch<React.SetStateAction<Pig[]>>;
}) => {
  //Table Field
