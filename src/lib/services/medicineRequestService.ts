...
export const medicineRequestService = {
    getMedicineRequest: (pageIndex: number, pageSize: number) => http.get(endpoint, { params: { pageIndex: pageIndex.toString() || "", pageSize: pageSize.toString() || "" }, allowCaching: false }),
