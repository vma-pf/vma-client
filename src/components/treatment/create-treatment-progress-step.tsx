...
import { getBorderClassNameByHerdStatus, getClassNameByHerdStatus } from "../herds/utils";
import { useAppDispatch } from "@oursrc/lib/hooks";
import { setTreatmentProgressSteps } from "@oursrc/lib/features/treatment-progress-step/treatment-progress-step-slice";

const CreateTreatmentProgressStep = ({ steps }: any) => {
  ...
  const handleStepClick = (index: number) => {
    ...
    setData(dataUpdate);
    dispatch(setTreatmentProgressSteps(dataUpdate));
    // save to local storage
    localStorage.setItem("treatmentProgressSteps", JSON.stringify(dataUpdate));
  };
...
export default CreateTreatmentProgressStep;
